...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background to-secondary/30">
      <div className="container max-w-5xl py-12 px-4 sm:px-6 lg:py-16">
        <header className="text-center mb-12 animate-fade-in">
          <h1 className="text-4xl font-bold tracking-tight mb-2">LUTs Generator</h1>
        ...
        <footer className="mt-16 text-center text-sm text-muted-foreground">
          <p>
            Created with Lovable • Transform your photos with custom color grading
          </p>
        </footer>
      </div>
    </div>
